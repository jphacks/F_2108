...
export type AudioWavePropsRefType = {
  play: () => void
  pause: () => void
}

const AudioIndicator = React.forwardRef<AudioWavePropsRefType, AudioWaveProps>(
  ({ comment, onClickStart, onClickPause, onPlayEnd, titleRender }, ref) => {
    // グラフで表示する波形データ
    ...
    const [, setProgressMs] = useState<number>(0)
